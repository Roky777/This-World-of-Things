...
export function renderGameUi(state, level) {
  ...
  if (state.screen === "complete") {
    ...
    screen.setAttribute("aria-label", "This World of Things Master certificate");
    ...
    card.innerHTML = `
      ...
      <p class="game-certificate__eyebrow">Things Lab Champion</p>
      <h2>Things Sorting <em>Master!</em></h2>
      ...
      <div class="game-certificate__stamps" aria-label="Skills mastered">
        <div class="game-certificate__stamp game-certificate__stamp--shapes"><i aria-hidden="true">◉</i><strong>Visibility</strong></div>
        <div class="game-certificate__stamp game-certificate__stamp--families"><i aria-hidden="true">◆</i><strong>Materials</strong></div>
        <div class="game-certificate__stamp game-certificate__stamp--motion"><i aria-hidden="true">🌿</i><strong>Origins</strong></div>
      </div>
